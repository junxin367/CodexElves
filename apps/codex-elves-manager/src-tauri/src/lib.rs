...
pub fn run() {
    ...
    let run_result = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::load_workspace_checkpoint_management,
            commands::save_workspace_checkpoint_settings,
            commands::set_workspace_checkpoint_enabled,
            commands::cleanup_workspace_checkpoint_storage,
            commands::delete_workspace_checkpoint_data,
            commands::open_workspace_checkpoint_storage,
            commands::open_codex_home_directory,
            ...
            commands::read_local_proxy_logs,
            commands::read_local_proxy_log_detail,
            commands::clear_local_proxy_logs,
            ...
            commands::clone_skin,
            commands::export_skin_to_path,
            commands::import_skin_from_path,
            commands::install_builtin_skin_presets,
