pub use codex_elves_core::install::{
...
pub fn install_entrypoints() -> InstallActionResult {
    codex_elves_core::install::install_entrypoints(&InstallOptions::default())
}

pub fn uninstall_entrypoints(options: InstallOptions) -> InstallActionResult {
    codex_elves_core::install::uninstall_entrypoints(&options)
}

pub fn repair_shortcuts() -> InstallActionResult {
    codex_elves_core::install::repair_entrypoints(&InstallOptions::default())
}
