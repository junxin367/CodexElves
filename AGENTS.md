...
唯一例外：脚本市场兼容旧数据源时允许保留 `BigPizzaV3/CodexElvesScriptMarket`。
...
```powershell
git grep -n -E "codex-plus|codex_plus|CodexPlusPlus|Codex\\+\\+" -- apps crates assets scripts README.md README_EN.md Cargo.toml
